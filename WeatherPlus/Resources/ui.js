  ...
  var WeatherPlusContainer = ({ react, setupController }) => {
    ...
    const tabs = [
      ...
      },
      {
        ...
        content: /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h4", { className: "mb-2" }, model.MessageRain), /* @__PURE__ */ import_react.default.createElement(Button, { style: { textAlign: "center" }, color: "primary", onClick: () => trigger("OnSetRain") }, /* @__PURE__ */ import_react.default.createElement(Icon, { icon: "gem", fa: true }), "\xA0Rain"), /* @__PURE__ */ import_react.default.createElement("span", null, " "), /* @__PURE__ */ import_react.default.createElement(Button, { style: { textAlign: "center" }, color: "primary", onClick: () => trigger("OnSetSnow") }, /* @__PURE__ */ import_react.default.createElement(Icon, { icon: "snowflake", fa: true }), "\xA0Snow"), /* @__PURE__ */ import_react.default.createElement("span", null, " "), /* @__PURE__ */ import_react.default.createElement(Button, { style: { textAlign: "center" }, color: "primary", onClick: () => trigger("OnSetSun") }, /* @__PURE__ */ import_react.default.createElement(Icon, { icon: "sun", fa: true }), "\xA0Sun"), /* @__PURE__ */ import_react.default.createElement("span", null, " "), /* @__PURE__ */ import_react.default.createElement(Button, { style: { textAlign: "center" }, color: "primary", onClick: () => trigger("OnSetDefaults") }, /* @__PURE__ */ import_react.default.createElement(Icon, { icon: "hand", fa: true }), "\xA0Default"), /* @__PURE__ */ import_react.default.createElement("span", null, " "), /* @__PURE__ */ import_react.default.createElement("h4", null, "Set Temperature"), /* @__PURE__ */ import_react.default.createElement("span", null, " "), /* @__PURE__ */ import_react.default.createElement(FormCheckBox, { checked: model.TemperatureOverride, onToggle: (value) => onTemperatureOverride(value) }), /* @__PURE__ */ import_react.default.createElement("span", null, " "), /* @__PURE__ */ import_react.default.createElement(
          Slider,
          {
            value: toSliderValue,
