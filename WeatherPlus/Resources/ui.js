(() => {
  ...
  var WeatherPlusContainer = ({ react, setupController }) => {
    ...
    return model.IsVisible ? /* @__PURE__ */ import_react.default.createElement(TabModal, { size: "lg", tabs, onClose: closeModal, fixed: true, className: "WeatherPlusContainer" }) : null;
  };
